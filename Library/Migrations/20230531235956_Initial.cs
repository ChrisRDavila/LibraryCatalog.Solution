...
namespace Library.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthorId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    AFirstName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ALastName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                name: "LibrarianCopies",
                columns: table => new
                {
                    LibrarianCopyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CopyId = table.Column<int>(type: "int", nullable: false),
                    LibrarianId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibrarianCopies", x => x.LibrarianCopyId);
                    table.ForeignKey(
                        name: "FK_LibrarianCopies_Copies_CopyId",
                        column: x => x.CopyId,
                        principalTable: "Copies",
                        principalColumn: "CopyId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LibrarianCopies_Librarians_LibrarianId",
            ...
            migrationBuilder.CreateTable(
                name: "PatronCheckouts",
                columns: table => new
                {
                    PatronCheckoutId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CheckoutId = table.Column<int>(type: "int", nullable: false),
                    PatronId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatronCheckouts", x => x.PatronCheckoutId);
                    table.ForeignKey(
                        name: "FK_PatronCheckouts_Checkouts_CheckoutId",
                        column: x => x.CheckoutId,
                        principalTable: "Checkouts",
                        principalColumn: "CheckoutId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatronCheckouts_Patrons_PatronId",
                        column: x => x.PatronId,
                        principalTable: "Patrons",
                        principalColumn: "PatronId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LibrarianCopies_CopyId",
                table: "LibrarianCopies",
                column: "CopyId");

            migrationBuilder.CreateIndex(
                name: "IX_LibrarianCopies_LibrarianId",
                table: "LibrarianCopies",
                column: "LibrarianId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatronCheckouts_CheckoutId",
                table: "PatronCheckouts",
                column: "CheckoutId");

            migrationBuilder.CreateIndex(
                name: "IX_PatronCheckouts_PatronId",
                table: "PatronCheckouts",
                column: "PatronId");
